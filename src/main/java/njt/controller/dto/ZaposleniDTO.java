...
public class ZaposleniDTO implements Serializable{
    ...
    private PozicijaDTO pozicija_id_poz;
    ...
    public ZaposleniDTO(int id_zaposleni, String ime, String prezime, Date datum_rodjenja, PozicijaDTO pozicija_id_poz, String korisnicko_ime, String korisnicka_sifra) {
    ...
    public PozicijaDTO getPozicija_id_poz() {
        return pozicija_id_poz;
    }

    public void setPozicija_id_poz(PozicijaDTO pozicija_id_poz) {
        this.pozicija_id_poz = pozicija_id_poz;
    }
